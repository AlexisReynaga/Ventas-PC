...
<div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 mt-8 min-h-[100vh] flex flex-col">
    <div class="flex justify-between items-center mb-6">
        ...
        <button onclick="window.print()" class="px-4 py-2 rounded bg-emerald-500 hover:bg-emerald-600 text-[#0B0E14] font-semibold text-sm">Imprimir Ticket</button>
    </div>
    ...
    <table class="min-w-full text-sm mb-8 border border-gray-800 rounded">
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="2" class="p-3 text-center text-gray-500">Sin productos.</td></tr>
            @endforelse
        </tbody>
    </table>
    </div>
